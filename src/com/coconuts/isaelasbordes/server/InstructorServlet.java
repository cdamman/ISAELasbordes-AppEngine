...
public class InstructorServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        if(instructor != null) {
        	...
        	if(!showAll)
        		resp.getWriter().println("  <br><br><center><h4>Vols de mes élèves / <a href=\"instructor?show=all\">Tous les vols</a></h4></center>"+
            	        "  <table border=\"1\" align=\"center\">" +
            	        "    <tr><th>&nbsp;Détenteur du téléphone&nbsp;</th><th>&nbsp;Nom du vol&nbsp;</th><th>&nbsp;Date&nbsp;</th><th>&nbsp;Voir&nbsp;</th><th>&nbsp;Télécharger&nbsp;</th><th>&nbsp;Supprimer&nbsp;</th></tr>");
        	else
        		resp.getWriter().println("  <br><br><center><h4><a href=\"instructor?show=student\">Vols de mes élèves</a> / Tous les vols</h4></center>"+
            	        "  <table border=\"1\" align=\"center\">" +
        				"    <tr><th>&nbsp;Détenteur du téléphone&nbsp;</th><th>&nbsp;Nom du vol&nbsp;</th><th>&nbsp;Date&nbsp;</th><th>&nbsp;Voir&nbsp;</th><th>&nbsp;Télécharger&nbsp;</th><th>&nbsp;Instructeur&nbsp;</th></tr>");
		        		        	...
		        		        	if(!showAll) {
					                	for (Student s : results2) {
				                			resp.getWriter().println(
					            		        "    <tr>"+
					            		        "      <td>&nbsp;"+s.getName()+"&nbsp;</td><td>&nbsp;"+f.getFlightName()+"&nbsp;</td><td>&nbsp;"+f.getHumanDate()+"&nbsp;</td><td><center><a class=\"zocial secondary\" href =\"see?deviceID="+f.getDeviceRegistrationID()+"&date="+f.getDate()+"&name="+s.getName()+"\" target=\"_blank\">Voir</a></center></td><td><center><a class=\"zocial secondary\" href =\"get?deviceID="+f.getDeviceRegistrationID()+"&date="+f.getDate()+"\">Télécharger</a></center></td><td><center><a class=\"zocial secondary\" href =\"del?deviceID="+f.getDeviceRegistrationID()+"&date="+f.getDate()+"\">Supprimer</a></center></td>"+
					            		        "    </tr>");
				                			noFlights = false;
					                	}
		        		        	} else {
					                	...
					                	for (Student s : results2) {
					    	        		...
					    	        		if(!instructorName.isEmpty()) {
						    	        		resp.getWriter().println(
						            		        "    <tr>"+
						            		        "      <td>&nbsp;"+s.getName()+"&nbsp;</td><td>&nbsp;"+f.getFlightName()+"&nbsp;</td><td>&nbsp;"+f.getHumanDate()+"&nbsp;</td><td><center><a class=\"zocial secondary\" href =\"see?deviceID="+f.getDeviceRegistrationID()+"&date="+f.getDate()+"&name="+s.getName()+"\" target=\"_blank\">Voir</a></center></td><td><center><a class=\"zocial secondary\" href =\"get?deviceID="+f.getDeviceRegistrationID()+"&date="+f.getDate()+"\">Télécharger</a></center></td><td>&nbsp;"+instructorName+"&nbsp;</td>"+
						            		        "    </tr>");
					                			noFlights = false;
					    	        		}
					                	}
        	...
        	resp.getWriter().println("<html><head>"+
        			...
        			"<form action=\"instructor\" method=\"post\"><center><table>"+
	...
	public static String generateMail(String email, String name, String deviceID, String date, String humanDate) {
		return "mailto:"+email+"?subject=Fichier KML de ton vol du "+humanDate+"&body=Salut "+name+" !%0D%0A%0D%0ALe fichier KML de ton vol peut être téléchargé ici:%0D%0Ahttps://volmoteurlasbordes.appspot.com/get?deviceID="+deviceID+"%26date="+date+"%0D%0A%0D%0AA bientôt à Lasbordes !";
	}
}