	        	...
	        	if(newInstuctor != null && newInstuctor.equals("true")) {
	        		if(name != null && email != null && mdp != null && !name.isEmpty() && !email.isEmpty() && !mdp.isEmpty()) {
				        ...
				        try {
				        	...
				        	pm.makePersistent(i);
				        	resp.getWriter().println("Nouvel instructeur "+name+" créé !<br><meta http-equiv=\"Refresh\" content=\"3;URL=admin\">");
			        ...
			        try {
			            ...
			            try {
			                ...
			                if (results.iterator().hasNext()) {
			                	...
			                	resp.getWriter().println(
			            		        "    <tr>"+
			            		        "      <td>&nbsp;Aucun instructeur :'(&nbsp;</td><td></td><td></td><td><center><a class=\"zocial secondary\" href=\"admin?new=true\">Nouvel instructeur</a></center></td>"+
			            		        "    </tr>");
			                }
			            } finally {
			                query.closeAll();
