...
public class StudentServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		...
		Student student = ConnectionTools.studentAuthorized(session, email, mdp);
        if(student != null) {
	        ...
	        "  <div style=\"float: left;\"><font size=\"6\" face=\"Comic Sans MS\">Zone pilote élève</font></div><div style=\"float: right;\">Bienvenue "+student.getName()+"</div><br style=\"line-height: 22px;\"/><div style=\"float: right;\"><a class=\"zocial secondary\" href =\"student?logout=true\">Déconnexion</a></div>");
        	...
        	resp.getWriter().println("<html><head>"+
        			...
        			"<br><br><center><h3>Connexion<br><span style=\"font-size: 0.8em;\">Vols enregistrés avec l'application Android</span></h3></center>"+
        			...
        			"<center><hr width=\"400em\" style=\"margin-bottom: 1em;\"><h3>Connexion<br><span style=\"font-size: 0.8em;\">Vols enregistrés avec l'application web</span></h3><a class=\"zocial secondary\" href=\"student?email=webapp@isaelasbordes.appspot.com\">Se connecter</a></center></body></html>");
    	}
    }
